...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	let span0;
    	let t3;
    	let t4_value = /*lifespan*/ ctx[2] / 10 + "";
    	let t4;
    	let t5;
    	let input0;
    	let t6;
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "logo svelte-1qeayh9");
    			add_location(img, file, 92, 4, 3504);
    			attr_dev(button0, "class", "svelte-1qeayh9");
    			add_location(button0, file, 94, 8, 3586);
    			attr_dev(button1, "class", "svelte-1qeayh9");
    			add_location(button1, file, 101, 8, 3798);
    			attr_dev(span0, "class", "svelte-1qeayh9");
    			add_location(span0, file, 103, 12, 3906);
    			attr_dev(input0, "type", "range");
    			attr_dev(input0, "min", "1");
    			attr_dev(input0, "max", "50");
    			attr_dev(input0, "class", "svelte-1qeayh9");
    			add_location(input0, file, 104, 12, 3954);
    			attr_dev(div0, "class", "range-container svelte-1qeayh9");
    			add_location(div0, file, 102, 8, 3864);
    			attr_dev(span1, "class", "svelte-1qeayh9");
    			add_location(span1, file, 113, 12, 4190);
    			attr_dev(input1, "type", "range");
    			attr_dev(input1, "min", "10");
    			attr_dev(input1, "max", "100");
    			attr_dev(input1, "step", "10");
    			attr_dev(input1, "class", "svelte-1qeayh9");
    			add_location(input1, file, 114, 12, 4234);
    			attr_dev(div1, "class", "range-container svelte-1qeayh9");
    			add_location(div1, file, 112, 8, 4148);
    			attr_dev(div2, "class", "ui svelte-1qeayh9");
    			add_location(div2, file, 93, 4, 3561);
    			attr_dev(div3, "class", "menu svelte-1qeayh9");
    			add_location(div3, file, 91, 0, 3481);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if ((!current || dirty & /*lifespan*/ 4) && t4_value !== (t4_value = /*lifespan*/ ctx[2] / 10 + "")) set_data_dev(t4, t4_value);
